...
class CSNet(nn.Module):
    def __init__(self, classes, channels):
        ...
        self.Att4 = Attention_block(F_g=filters[2], F_l=filters[2], F_int=filters[2])#256,256,256
        self.Att3 = Attention_block(F_g=filters[1], F_l=filters[1], F_int=filters[1])#128,128,128
        self.Att2 = Attention_block(F_g=filters[0], F_l=filters[0], F_int=filters[0])#64,64,64
        self.Att1 = Attention_block(F_g=32, F_l=32, F_int=32)                        #32,32,32
