...
def AUC(path):   #path = './assets/octa/'
    ...
    for file in glob.glob(os.path.join(path, 'pred', '*pred.png')):
        ...
        #mask_path = '/home/leila/PycharmProjects/CSNet/assets/STARE(3)/mask.png' 添加注释
        mask_path = './assets/octa/'  # 更改路径
...
if __name__ == '__main__':
    #path = './assets/Padova1/'添加注释
    path = './assets/octa/'   #更换路径
    # auc = AUC(path)
